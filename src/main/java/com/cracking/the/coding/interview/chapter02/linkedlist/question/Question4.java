...
public class Question4 {
    ...
    public static MySinglyLinkedList<Integer> solve(MySinglyLinkedList<Integer> linkedList, int partitionElement) {
        ...
        while (current != null) {
            ...
            Node newNode = greaterThanList.new Node((Integer) current.content);
    ...
    public static MySinglyLinkedList<Integer> solve2(MySinglyLinkedList<Integer> linkedList, int partitionElement) {
        ...
        Node<Integer> current = linkedList.head;
        Node<Integer> itterator = linkedList.head;
        Node<Integer> defaultTail = linkedList.tail;
        Node<Integer> initialTail = linkedList.tail;
        Node<Integer> initialHead = linkedList.head;
        int headCount = 0;
        int tailCount = 0;
        while (current != null) {
    ...
    public static MySinglyLinkedList<Integer> resolve2(MySinglyLinkedList<Integer> linkedList, int partitionElement) {
        ...
        Node<Integer> current = linkedList.head;
        Node<Integer> left = linkedList.head;
        Node<Integer> right = linkedList.tail;

        Node<Integer> firstLeft = linkedList.head;
        Node<Integer> firstRight = linkedList.head;
