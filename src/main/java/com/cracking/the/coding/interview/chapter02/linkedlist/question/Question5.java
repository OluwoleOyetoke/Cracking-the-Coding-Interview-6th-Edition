...
public class Question5 {
     ...
     */
    public static MySinglyLinkedList<Integer> solve(MySinglyLinkedList<Integer> list1, MySinglyLinkedList<Integer> list2) {
        ...
        Node<Integer> currentList1 = list1.head;
        Node<Integer> currentList2 = list2.head;
        int val = 0;
        int carry = 0;
        int use = 0;
