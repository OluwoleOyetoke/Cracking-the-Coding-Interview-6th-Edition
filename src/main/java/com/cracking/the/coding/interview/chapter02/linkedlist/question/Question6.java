...
public class Question6 {
     ...
     */
    public static boolean solve(MySinglyLinkedList<String> list) {
        //Quick exit criteria
        if (list == null) {
            return false;
        } else if (list.size == 1) {
        ...
        while (current != null) {
            if ((evenPalindrome == true && counter <= (midPoint - 1)) || ((!evenPalindrome) && (counter < (midPoint - 1)))) {
                stack.add(current.content);
            } else if ((evenPalindrome == true && counter > (midPoint - 1)) || ((!evenPalindrome) && (counter > (midPoint - 1)))) {
    ...
    public static boolean solve2(MySinglyLinkedList list) {
        ...
        Node<String> latestTail = list.head;

        Node<String> previous = list.head;
        Node<String> current = list.head.nextNode;
        Node<String> nextNode = current.nextNode;
        boolean decision = true;
        while (current != null) {
     ...
     * @return true/false returns true if content of linked list is a palindrome
     */
    public static boolean solve3(MySinglyLinkedList<String> list) {
        if (list == null) {
            return false;
        }
        int listSize = list.size();
        ...
        Node<String> current = list.head;
        Node<String> next = list.head.nextNode;

        Node<String> reversePrevious = list.head.nextNode; //assuming tracking from the reverse direction
        Node<String> reverseCurrent = list.head;
        Node<String> reverseNext = null;
