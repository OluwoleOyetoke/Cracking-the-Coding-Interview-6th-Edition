...
public class Question8 {
     ...
     * not circular
     */
    public static Node<Integer> solve(MySinglyLinkedList<Integer> list) {
        if (list == null || list.size < 2) {
            return null;
        }
        Node<Integer> slower = list.head;
        Node<Integer> faster = list.head;
